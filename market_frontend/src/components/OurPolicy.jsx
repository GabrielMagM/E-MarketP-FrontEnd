...
function OurPolicy() {
  return (
    <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center px-20 py-12 text-xs sm:text-sm md:text-base text-gray-700 border-2 border-gray-600 '>
        <div>
